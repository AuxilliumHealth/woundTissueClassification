...
public class PieChartView extends View {
    ...
    public PieChartView(Context context, AttributeSet attrs) {
        ...
        whiteLinePaint.setColor(0);
        whiteLinePaint.setStrokeWidth(0);
        textPaint = new Paint();
        textPaint.setAntiAlias(true);
        textPaint.setColor(Color.BLACK);
        textPaint.setTextSize(PieHelper.sp2px(getContext(), 0));
        ...
        // Set layer type to software to enable shadow layer
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int holeRadius = PieHelper.dpToPx(getContext(), 20);

        // Draw the white circle at the center to create the hole effect
        Paint centerHolePaint = new Paint();
        centerHolePaint.setAntiAlias(true);
        centerHolePaint.setColor(Color.WHITE); // You can change this color to match your background if it's different
        canvas.drawCircle(pieCenterPoint.x, pieCenterPoint.y, holeRadius, centerHolePaint); // Use holeRadius for the center hole
